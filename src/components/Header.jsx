...
export default function Header({ kjøpt }) {
  return (
    <div className="flex items-center justify-center w-full h-20 shadow-lg p-15">
      ...
      <button className="fixed z-10 p-4 text-white transition-all duration-200 bg-red-600 rounded-full shadow-lg cursor-pointer top-6 right-6 hover:bg-red-700 active:scale-95">
        <ShoppingCart />
        {kjøpt.length >= 1 && (
